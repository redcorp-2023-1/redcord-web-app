...
.container_cover2 .text {
  max-width: 600px;
  margin-top: 20px;
}

.container_cover2 .text h1 {
  font-size: 42px;
  font-family: 'Roboto Slab', sans-serif;
  color: white;
}

.container_cover2 .text p {
  font-size: 16px;
...
.container_cover2 .text input:hover {
